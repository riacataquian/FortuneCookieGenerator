defmodule FortuneGenerator.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import FortuneGenerator.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&FortuneGenerator.ErrorHelpers.translate_error/1)
